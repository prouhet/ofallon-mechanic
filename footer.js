// footer.js - Complete Footer with Cross-Directory Navigation for O'Fallon Car Repair Directory
const crossNavHTML = `
    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
        <div style="display: flex; flex-wrap: wrap; gap: 40px; margin-bottom: 40px;">
            <div style="flex: 1; min-width: 200px;">
                <h3 style="margin-bottom: 10px;">O'Fallon Auto Repair Directory</h3>
                <p>Your guide to car repair in the 62269 area</p>
            </div>
            
            <div style="flex: 1; min-width: 200px;">
                <h4>Quick Links</h4>
                <ul style="list-style: none; margin-top: 15px;">
                    <li style="margin-bottom: 10px;"><a href="#hero" style="color: #fbb97b; text-decoration: none;">Home</a></li>
                    <li style="margin-bottom: 10px;"><a href="#matcher" style="color: #fbb97b; text-decoration: none;">Find Your Match</a></li>
                    <li style="margin-bottom: 10px;"><a href="#comparison" style="color: #fbb97b; text-decoration: none;">Comparison Chart</a></li>
                    <li style="margin-bottom: 10px;"><a href="#profiles" style="color: #fbb97b; text-decoration: none;">Shop Profiles</a></li>
                    <li style="margin-bottom: 10px;"><a href="#featured" style="color: #fbb97b; text-decoration: none;">Featured Shop</a></li>
                    <li style="margin-bottom: 10px;"><a href="#faq" style="color: #fbb97b; text-decoration: none;">FAQ</a></li>
                </ul>
            </div>
            
            <div style="flex: 2; min-width: 300px;">
                <h4>Disclaimer</h4>
                <p>This directory is for informational purposes only. Information is subject to change. Please contact individual auto repair shops for the most current services, pricing, and availability. We are not affiliated with any shop listed except our featured partner.</p>
            </div>
        </div>
        
        <div style="text-align: center; padding-top: 20px; border-top: 1px solid rgba(255, 255, 255, 0.1); font-size: 0.9rem;">
            <p>&copy; 2025 O'Fallon Auto Repair Directory. All rights reserved.</p>
        </div>
    </div>
</footer>
`;
